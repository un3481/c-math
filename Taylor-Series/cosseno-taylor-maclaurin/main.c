...
int main(){
    ...
    int op, opt, i, n, a, b;
    double ang, rad, ca, sstm;
    long double pot, fat, stm[20];

    printf("\n--------------------------------------------------------------------------------");
    printf("\n\nAPROXIMACAO DE COS(X) POR SERIE DE TAYLOR E MACLAURIN!");
    ...
    printf("\n--------------------------------------------------------------------------------");
    printf("\n\nCosseno calculado pelo computador:");
    printf("\nsen(%.3lf) = %.10lf",ang,ca);
    ...
    printf("\n--------------------------------------------------------------------------------");
    printf("\n\nPara determinar o cosseno de um novo angulo digite 1.");
    printf("\nPara sair digite 0.\n\n");
    scanf("%d",&op);
